...
isInter = 1; % Default 0. If you set to 1 then the interpolation will be activated.
...
for i = 1:8
    for j = 1:6
        ...
        d_asv_y3 = vl_asvcovdet_y3(im1, opt, f, des, isInter);
        ...
        save([nameF,'/ASV_y3'],'f','d_asv_y3','opt')
        t = toc;
